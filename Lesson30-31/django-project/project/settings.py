...
MIDDLEWARE = [
    ...
    'project.middlewares.UserActivityLoggingMiddleware',
]

# self.log_path = getattr(settings, 'USERS_ACTIVITY_LOG_PATH', 'usersActivity.log')

ROOT_URLCONF = "project.urls"
AUTH_USER_MODEL = "accounting.User"
USER_ACTIVITY_LOG_FILE = BASE_DIR / 'logs' / "usersActivity.log"
