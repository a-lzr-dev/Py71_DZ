...
SECRET_KEY = 'django-insecure-t=w5oemv$b40arf6fgt)91bp**(h^v$6@d4tcn71h!g8++yu$4'
...
MAX_RESERVATIONS_PER_USER_PER_DAY = 1 # лимит броней для одного пользователя на один день

UNFOLD = {
    "SITE_TITLE": "Reservations Admin",
    "SITE_HEADER": "Reservations Admin"
}
...
#CELERY_TASK_ROUTES = {
#    'apps.events.tasks.send_email_*': {'queue': 'email'},
#    'apps.events.tasks.notify_new_event': {'queue': 'email'},
#}
...
CELERY_BEAT_SCHEDULE = {
    'send_notifies_by_scheduler': {
        'task': 'apps.events.tasks.send_day_reminders',
